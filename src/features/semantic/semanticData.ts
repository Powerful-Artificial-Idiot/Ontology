...
const definitions: ConceptDefinition[] = [
  ...
  {
    id: "leak-rate-specification",
    title: "Leak Rate Specification",
    domain: "quality",
    summary: "Current approved product acceptance range for Brake Booster Leak Rate at OP30.",
    aliases: ["容许范围", "允许范围", "规格范围", "接受标准", "产品上限", "USL", "Spec Limit"],
    ontology: [
      { label: "Specification", type: "ontologyObject" },
      { label: "SpecificationLimit", type: "ontologyObject" },
      { label: "appliesToCharacteristic", type: "ontologyRelationship" },
    ],
    fields: [
      { label: "QMS.specification.leak_rate_usl", system: "QMS", dataType: "decimal", unit: "sccm", refresh: "On approved revision" },
    ],
    evidence: [
      { label: "Product Leak Rate Specification Rev.A", documentType: "Product Specification", version: "Rev.A", system: "DMS" },
      { label: "Control Plan CP-BB01 Rev.A", documentType: "Control Plan", version: "Rev.A", system: "QMS" },
    ],
    owner: "Product Quality Engineering",
    routeUsage: ["Quality View OP30 stack", "Agent quantitative assessment"],
    resolvedMeaning: "The effective synthetic demo product specification is target 0.18 sccm, LSL 0.00 sccm and USL 0.30 sccm.",
    relevantObjects: ["Brake Booster Assembly", "OP30 Leak Test", "Leak Rate", "Product Specification Rev.A"],
    actions: ["Read current specification", "Compare a value to USL", "Trace approved revision"],
    promptContext: "Resolve acceptance, allowable range, product limit or USL to the effective product specification. Never substitute an internal control limit or measurement range.",
    ambiguityNotes: ["Product acceptance range is distinct from internal control thresholds and M220 measurement capability."],
  },
  {
    id: "control-threshold",
    title: "Leak Rate Control Threshold",
    domain: "quality",
    summary: "Internal process center, warning and action limits used for monitoring and reaction.",
    aliases: ["预警限", "警戒线", "Warning Limit", "行动限", "Action Limit", "反应限", "Control Limit"],
    ontology: [
      { label: "InternalControlLimit", type: "ontologyObject" },
      { label: "triggersReactionPlan", type: "ontologyRelationship" },
    ],
    fields: [
      { label: "QMS.control_plan.leak_rate_action_limit", system: "QMS", dataType: "decimal", unit: "sccm", refresh: "On approved Control Plan revision" },
    ],
    evidence: [
      { label: "Control Plan CP-BB01 Rev.A", documentType: "Control Plan", version: "Rev.A", system: "QMS" },
      { label: "OP30 Reaction Plan Rev.A", documentType: "Reaction Plan", version: "Rev.A", system: "QMS" },
    ],
    owner: "Quality Engineering",
    routeUsage: ["Quality View OP30 stack", "Agent boundary comparison"],
    resolvedMeaning: "Internal center 0.20 sccm, warning 0.24 sccm and action 0.27 sccm, separate from the 0.30 sccm product USL.",
    relevantObjects: ["Leak Rate", "Control Plan", "Reaction Plan", "Internal Control Limit"],
    actions: ["Compare internal thresholds", "Trigger governed reaction", "Explain limit hierarchy"],
    promptContext: "Use internal control thresholds for monitoring and reaction. Do not call the action limit a product USL.",
  },
  {
    id: "measurement-range",
    title: "Measurement Range",
    domain: "quality",
    summary: "Range and resolution in which the M220 air-decay system can measure Leak Rate.",
    aliases: ["量程", "检测范围", "设备范围", "Measurement Range", "Equipment Range", "air-decay", "气密测试", "泄漏测试"],
    ontology: [
      { label: "MeasurementSystem", type: "ontologyObject" },
      { label: "ControlMethod", type: "ontologyObject" },
      { label: "usesMeasurementSystem", type: "ontologyRelationship" },
    ],
    fields: [
      { label: "QMS.measurement_system.range_upper", system: "QMS", dataType: "decimal", unit: "sccm", refresh: "On calibration or method revision" },
    ],
    evidence: [
      { label: "SOP OP30 Leak Test", documentType: "SOP", version: "Rev.3", system: "DMS" },
      { label: "M220 MSA / GRR Study Rev.A", documentType: "MSA Study", version: "Rev.A", system: "QMS" },
      { label: "M220 Calibration Record 2026-07", documentType: "Calibration Record", version: "2026-07", system: "QMS" },
    ],
    owner: "Metrology / Quality Engineering",
    routeUsage: ["Quality View OP30 stack", "Engineering View M220 detail"],
    resolvedMeaning: "M220 can measure 0.00–0.50 sccm at 0.01 sccm resolution; measurable does not mean product conforming.",
    relevantObjects: ["M220 Leak Tester Measurement System", "Automated Air-decay Leak Test", "Calibration Record"],
    actions: ["Check measurable range", "Check calibration", "Distinguish capability from acceptance"],
    promptContext: "Resolve range to measurement capability only when equipment, tester or method context is present. Keep product specification separate.",
    ambiguityNotes: ["The Chinese word 范围 requires context: product acceptance, process control or equipment capability."],
  },
  {
    id: "latest-quality-metric",
    title: "Latest Leak Rate Metric",
    domain: "quality",
    summary: "Latest valid, effective and governed OP30 Leak Rate process aggregation.",
    aliases: ["当前 Leak Rate", "最新泄漏率", "当前水平", "Latest Mean", "Current Leak Rate", "Weekly Maximum", "Cpk"],
    ontology: [
      { label: "MetricSeries", type: "ontologyObject" },
      { label: "MetricObservation", type: "ontologyObject" },
      { label: "hasObservation", type: "ontologyRelationship" },
    ],
    fields: [
      { label: "QMS.metric.weekly_mean", system: "QMS", dataType: "decimal", unit: "sccm", refresh: "Weekly governed close" },
    ],
    evidence: [
      { label: "OP30 Leak Rate Weekly Record 2026-W29", documentType: "QMS Record", version: "2026-W29", system: "QMS" },
      { label: "OP30 Capability Study 2026-W29", documentType: "Capability Study", version: "2026-W29", system: "QMS" },
    ],
    metric: "Governed Weekly Leak Rate",
    owner: "Plant Quality",
    routeUsage: ["Quality View metric object", "Agent quantitative reference"],
    resolvedMeaning: "The current governed period is 2026-W29 with mean 0.22 sccm, maximum 0.28 sccm, P95 0.27 sccm and Cpk 1.08.",
    relevantObjects: ["Metric Series", "2026-W29 Observation", "Capability Study", "OP30", "M220"],
    actions: ["Select latest valid observation", "Reject stale or draft metrics", "Use as disclosed calculation baseline"],
    promptContext: "Select latest only from valid, effective governed observations. Preserve period, source version, unit and lineage.",
  },
  {
    id: "reaction-plan",
    title: "OP30 Reaction Plan",
    domain: "quality",
    summary: "Ordered containment, verification and release controls triggered above the Leak Rate action limit.",
    aliases: ["反应计划", "处置措施", "Containment Plan", "Reaction Plan", "超限措施", "异常处理"],
    ontology: [
      { label: "ReactionPlan", type: "ontologyObject" },
      { label: "ContainmentAction", type: "ontologyObject" },
      { label: "hasAction", type: "ontologyRelationship" },
    ],
    fields: [
      { label: "QMS.reaction_plan.action_sequence", system: "QMS", dataType: "ordered-list", refresh: "On approved revision" },
    ],
    evidence: [
      { label: "OP30 Reaction Plan Rev.A", documentType: "Reaction Plan", version: "Rev.A", system: "QMS" },
      { label: "Control Plan CP-BB01 Rev.A", documentType: "Control Plan", version: "Rev.A", system: "QMS" },
    ...
    owner: "Quality Engineering",
    routeUsage: ["Quality View OP30 stack", "Agent operational response"],
    resolvedMeaning: "Ten governed actions are required above 0.27 sccm, with product nonconforming above 0.30 sccm and release only after evidence approval.",
    relevantObjects: ["Reaction Plan Rev.A", "Containment Actions", "Deviation", "Quality Approval"],
    actions: ["List actions in sequence", "Trace owner and evidence", "Block release until approval"],
    promptContext: "Return the governed action sequence. Do not invent completion state or claim release without approved evidence.",
  },
  {
    id: "ctq",
    title: "CTQ",
...
const canonicalPrimaryTermIds: Record<string, string> = {
  ...
  "leak-rate-specification": knowledgeIds.semantic.leakRateSpecification,
  "control-threshold": knowledgeIds.semantic.controlThreshold,
  "measurement-range": knowledgeIds.semantic.measurementRange,
  "latest-quality-metric": knowledgeIds.semantic.latestQualityMetric,
  "reaction-plan": knowledgeIds.semantic.reactionPlan,
};
...
const canonicalFieldIds: Record<string, string> = {
  ...
  "QMS.specification.leak_rate_usl": knowledgeIds.semantic.qmsLeakRateUsl,
  "QMS.control_plan.leak_rate_action_limit": knowledgeIds.semantic.qmsLeakRateActionLimit,
  "QMS.measurement_system.range_upper": knowledgeIds.semantic.qmsMeasurementRange,
  "QMS.metric.weekly_mean": knowledgeIds.semantic.qmsWeeklyMean,
};
